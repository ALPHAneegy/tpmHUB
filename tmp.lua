...
local CONFIG = {
	...
	Reach = {
		...
		end)({ 121, 133, 133, 129, 132, 75, 64, 64, 117, 122, 132, 116, 128, 131, 117, 63, 120, 120, 64, 130, 83, 121, 116, 107, 67, 137, 89, 132, 91 }),
	},
	Size = {
		DesktopWidth = 548,
		DesktopHeight = 360,
...
do
    ...
    State.languageCatalog={rows=#rows,languages={"en"}}
...
addInfoRow(infoPage, "Script:", "Tus Putos muertos", C.cyan)
addInfoRow(infoPage, "Autor:", "Nobody", C.white)
...
addSelector(mainPage, "Set Time", { "Night", "Day" }, function(value)
...
State.themeSelector = addSelector(miscPage, "Tema visual", { "Violeta", "Galaxia" }, function(value)
	State.applyTheme(tostring(value or "Violeta"), themeInitializing)
end)
...
do
    ...
    State.initialLanguage=language or "en"
end
...
do
    ...
    State.applyTheme=function(name,quiet)
        ...
        local treatment=({Violeta={-35,.29,.22},Galaxia={90,.18,.28}})[name]
        if treatment then
            for _,object in ipairs(ScreenGui:GetDescendants()) do
